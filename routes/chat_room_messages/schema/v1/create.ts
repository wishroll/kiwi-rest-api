...
export const createChatRoomMessageBody = {
  type: 'object',
  properties: {
    type: {
      type: 'string',
      enum: ['song_message', 'text', 'video', 'photo'],
      description: 'The type of the chat room message',
    },
    text: { type: 'string', description: 'The text associated with the chat room message' },
    song_message_id: {
      type: 'integer',
      description: 'The primary key id of the associated song message',
    },
  },
  required: ['type'],
} as const;

export const createChatRoomMessageParams = {
  type: 'object',
  properties: {
    id: { type: 'integer', description: 'The id of the chat room the message is in.' },
  },
  required: ['id'],
} as const;
  
export const createChatRoomMessageSchema = {
  description: 'Create a chat room message',
  tags: ['Chat Room Messages'],
  summary: 'Create a chat room message',
  body: createChatRoomMessageBody,
  params: createChatRoomMessageParams,
  headers: authHeaders,
  response: {
    201: {
...
export type CreateChatRoomMessageBody = FromSchema<typeof createChatRoomMessageBody>;
export type CreateChatRoomMessageParams = FromSchema<typeof createChatRoomMessageParams>;
