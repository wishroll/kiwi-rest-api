...
export const showChatRoomMessageParams = {
  type: 'object',
  properties: {
...
export type ShowChatRoomMessageParams = FromSchema<typeof showChatRoomMessageParams>;
