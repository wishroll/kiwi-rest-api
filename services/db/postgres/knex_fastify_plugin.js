...
const readDB = generateAndConfigKnexDBMultipleUrls(MAX_CONNECTIONS, MAX_CONNECTIONS, productionDatabaseUrls.length > 0 ? productionDatabaseUrls : stagingDatabaseUrls)
