...
exports.up = function (knex) {
  return knex.schema.createTable('firebase_cloud_messaging_tokens', table => {
    ...
    table
      .bigIncrements('id')
      .unique({ indexName: 'index_id_firebase_cloud_messaging_tokens', deferrable: 'immediate' });
    table
      .uuid('uuid', { useBinaryUuid: true })
      .notNullable()
      .defaultTo(knex.raw('gen_random_uuid()'))
      .unique({ indexName: 'index_uuid_firebase_cloud_messaging_tokens', deferrable: 'immediate' });
